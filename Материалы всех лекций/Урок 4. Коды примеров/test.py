...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        Form.resize(400, 300)
        self.gridLayoutWidget = QtWidgets.QWidget(Form) #виджет
        self.gridLayoutWidget.setGeometry(QtCore.QRect(80, 50, 226, 108))
        self.gridLayoutWidget.setObjectName("gridLayoutWidget")


        self.gridLayout_2 = QtWidgets.QGridLayout(self.gridLayoutWidget)#сетка
        self.gridLayout_2.setContentsMargins(0, 0, 0, 0)
        self.gridLayout_2.setObjectName("gridLayout_2")

        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()#слои
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")

        self.label_2 = QtWidgets.QLabel(self.gridLayoutWidget)#надписи
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)

        self.lineEdit_2 = QtWidgets.QLineEdit(self.gridLayoutWidget)# текстовые поля
        self.lineEdit_2.setObjectName("lineEdit_2")
        self.horizontalLayout_3.addWidget(self.lineEdit_2)

        self.gridLayout_2.addLayout(self.horizontalLayout_3, 0, 0, 1, 1)#слои
        self.horizontalLayout_2 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_2.setObjectName("horizontalLayout_2")
        self.label = QtWidgets.QLabel(self.gridLayoutWidget)
        self.label.setObjectName("label")
        self.horizontalLayout_2.addWidget(self.label)#надписи


        self.spinBox_2 = QtWidgets.QSpinBox(self.gridLayoutWidget)#слои спинбоксы
